...
const mandateKeys = [
  { title: 'mandate1Title', sub: 'mandate1Sub' },
  { title: 'mandate2Title', sub: 'mandate2Sub' },
  { title: 'mandate3Title', sub: 'mandate3Sub' },
] as const;
      ...
      <div className="wrap" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        ...
        <div style={{ position: 'relative' }}>
          <div className="imgwrap" style={{ aspectRatio: '4/5', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-lg)' }}>
            ...
            <img src={img('handshake', 1100)} alt={t('imageAlt')} />
          </div>
          <div style={{
            ...
            <div className="mono" style={{ color: 'var(--accent)', letterSpacing: '0.12em' }}>{t('headOffice')}</div>
            <div className="h4" style={{ marginTop: 8, color: 'var(--fg-1)' }}>{t('headOfficeCity')}</div>
            <div className="small" style={{ marginTop: 4 }}>{t('headOfficeNote')}</div>
          </div>
