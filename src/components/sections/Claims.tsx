...
const stepKeys = [
  { n: '01', title: 'Claims.step1Title', body: 'Claims.step1Body' },
  { n: '02', title: 'Claims.step2Title', body: 'Claims.step2Body' },
  { n: '03', title: 'Claims.step3Title', body: 'Claims.step3Body' },
  { n: '04', title: 'Claims.step4Title', body: 'Claims.step4Body' },
] as const;
    ...
    <section id="claims" className="section" style={{ background: 'var(--paper)' }}>
      <div className="wrap">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'end', marginBottom: 64 }}>
          <div>
            <div className="eyebrow"><span className="tick" />{t('Claims.eyebrow')}</div>
            <h2 className="h2" style={{ margin: '22px 0 0' }}>{t('Claims.title')}</h2>
          </div>
